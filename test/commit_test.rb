...
class TestCommit < Rugged::TestCase
  ...
  def test_commit_stats
    commits = %w[8496071c1b46c854b31185ea97743be6a8774479
                 5b5b025afb0b4c913b4c338a42934a3863bf3644
                 36060c58702ed4c2a40832c51758d5344201d89a].map { |rev| Rugged::Commit.lookup(@repo, rev) }
    stats = Rugged::Commit.stats(@repo, commits)
    assert_equal stats[0].adds, 1
    assert_equal stats[0].dels, 0
    assert_equal stats[0].oid, '8496071c1b46c854b31185ea97743be6a8774479'
    assert_equal stats[0].committer[:name], 'Scott Chacon'
    assert_equal stats[0].committer[:email], 'schacon@gmail.com'
    assert_equal stats[0].author[:name], 'Scott Chacon'
    assert_equal stats[0].author[:email], 'schacon@gmail.com'
    assert_equal stats[1].adds, 1
    assert_equal stats[1].dels, 0
    assert_equal stats[1].oid, '5b5b025afb0b4c913b4c338a42934a3863bf3644'
    assert_equal stats[1].committer[:name], 'Scott Chacon'
    assert_equal stats[1].committer[:email], 'schacon@gmail.com'
    assert_equal stats[1].author[:name], 'Scott Chacon'
    assert_equal stats[1].author[:email], 'schacon@gmail.com'
    assert_equal stats[2].adds, 4
    assert_equal stats[2].dels, 0
    assert_equal stats[2].oid, '36060c58702ed4c2a40832c51758d5344201d89a'
    assert_equal stats[2].committer[:name], 'Scott Chacon'
    assert_equal stats[2].committer[:email], 'schacon@gmail.com'
    assert_equal stats[2].author[:name], 'Scott Chacon'
    assert_equal stats[2].author[:email], 'schacon@gmail.com'
  end
